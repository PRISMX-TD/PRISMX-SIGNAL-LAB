...
export default function AuroraBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute right-[-10rem] top-1/4 h-[26rem] w-[26rem] rounded-full bg-neon-cyan/15 blur-[120px] animate-float" />
      <div className="absolute bottom-[-8rem] left-1/3 h-[24rem] w-[24rem] rounded-full bg-neon-pink/12 blur-[120px] animate-float-slow" />
      {/* 顶部柔光 / top vignette */}
