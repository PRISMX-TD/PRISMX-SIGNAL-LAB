...
export default function AuroraBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute -left-40 top-0 h-[28rem] w-[28rem] rounded-full bg-[#7c3aed]/[0.16] blur-[120px] animate-float-slow" />
      <div className="absolute right-[-10rem] top-1/4 h-[26rem] w-[26rem] rounded-full bg-[#3b5bdb]/[0.13] blur-[120px] animate-float" />
      <div className="absolute bottom-[-8rem] left-1/3 h-[24rem] w-[24rem] rounded-full bg-[#14a4bb]/[0.11] blur-[120px] animate-float-slow" />
      {/* 顶部柔光 / top vignette */}
